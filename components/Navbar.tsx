...
const Navbar = ({ className }: { className?: string }) => {
  ...
  return (
    <div className={cn("fixed top-10 inset-x-0 max-w-2xl mx-auto z-50 bg-black text-white rounded-4xl border border-white/[0.2]", className)}>
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Our Courses">
          <div className="flex flex-col space-y-4 text-sm">
            ...
            <HoveredLink href="/courses/music-theory-basics">Basic Music Theory</HoveredLink>
